...
{{--        <p class="text-muted mb-3">Read the <a href="https://jqueryvalidation.org/" target="_blank"> Official jQuery Validation Documentation </a>for a full list of instructions and other options.</p>--}}
        <form  action="{{ route('recipes.store') }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <input id="image" class="form-control" name="image" type="text">
          </div>
          <div class="mb-3">
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <select class="js-example-basic-single form-select" name="ingredients[0][name][]" multiple data-width="100%">
