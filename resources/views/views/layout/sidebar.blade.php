      ...
      <li class="nav-item {{ active_class(['apps/calendar']) }}">
        ...
        <li class="nav-item {{ active_class(['recipes']) }}">
            <a href="{{route('recipes.index')}}" class="nav-link">
                <svg stroke="currentColor" class="link-icon text-light" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg">
                    <path d="M21 15c0-4.625-3.507-8.441-8-8.941V4h-2v2.059C6.507 6.559 3 10.375 3 15v2h18V15zM5 15c0-3.859 3.141-7 7-7s7 3.141 7 7H5zM2 18H22V20H2z"></path>
                </svg>
        ...
        <div class="collapse {{ show_class(['forms/*']) }}" id="forms">
          <ul class="nav sub-menu">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                  <a href="{{route('recipes.create')}}" class="nav-link {{ active_class(['recipes/create']) }}">Form Recipe</a>
              </li>
              <li class="nav-item">
                  <a href="{{ route('ingredients.create') }}" class="nav-link {{ active_class(['ingredients/create']) }}">Form Ingredient</a>
              </li>
          </ul>
        </div>
      </li>
      ...
      <li class="nav-item {{ active_class(['tables/*']) }}">
        ...
        <div class="collapse {{ show_class(['tables/*']) }}" id="tables">
          <ul class="nav sub-menu">
            ...
            <li class="nav-item">
              <a href="{{ route('recipes.index') }}" class="nav-link {{ active_class(['recipes']) }}">Recipes</a>
            </li>
              <li class="nav-item">
