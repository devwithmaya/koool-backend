                ...
                <div class="card-body">
                    ...
                    <form  action="{{ route('recipes.update',$recipe) }}" method="POST">
                        ...
                        <div id="ingredients-container" class="mb-3">
                            ...
                            <label class="form-label mb-1">Ingrédients</label>
                            ...
                            <div>
                                @foreach($recipe->categories as $categories)
                                    <div class="form-check form-check-inline">
                                        <input type="checkbox" name="categories[]" class="form-check-input" checked id="checkInline{{$categories->id}}" value="{{ $categories->id }}">
                                        <label class="form-check-label" for="checkInline{{$categories->id}}">
                                            {{$categories->name}}
                                        </label>
                                    </div>
                                @endforeach
